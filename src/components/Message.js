...
const Message = (props) => {
  const { role, message, pause, help, onTypingComplete, onTypingUpdate } = props;
              ...
              <Typewriter
                ...
                onInit={(typewriter) => {
                  ...
                  lines.forEach((line, index) => {
                    ...
                    // To ensure the latest messages are always visible to user and scroll to the bottom. 
                    // The following lines need to be modified together with answers generated by the the nlpResponse
                    if (index !== lines.length - 1) {
                      typewriter.typeString('. ');
                    }
                  });

                  typewriter.callFunction(onTypingComplete);
                  typewriter.start();
                }}
              />
            )}
