...
const Landing = () => {
  ...
  const sampleQueries = [
    ...
    'what is the fraction of cells expressing ACE2, FOXJ1, HIF1A, KRT5, COL1A1, COL2A1, COL13A1, COL14A1, VWF, CD19, APOE, CYP1A1, NOS2, TGFBI, PDGFRA, CRH, GZMA in human lung?',
