export const fetchWikiImage = async (searchTerm) => {
    try {
      // Search for Wikipedia page
      const searchUrl = `https://en.wikipedia.org/w/api.php?action=query&format=json&prop=pageimages|pageterms&generator=search&gsrsearch=${searchTerm}&gsrlimit=1&origin=*`;
